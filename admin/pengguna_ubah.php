<?php
    ...
    mysqli_stmt_prepare($stmt_select, "SELECT hak_akses FROM tbl_pengguna WHERE id=?");
     ...
     *   admin          --> harus 'admin'
     *   siswa          --> harus 'siswa'
     *   guru           --> harus 'guru' atau 'kepala_sekolah'
     *   kepala_sekolah --> harus 'guru' atau 'kepala_sekolah'
    */
    if (
