<?php
    ...
    mysqli_stmt_bind_param($stmt, 'issssssiiiisi', $id_alumni, $nama_perusahaan, $jabatan, $deskripsi_pekerjaan, $tanggal_masuk, $tanggal_keluar, $alamat_simpel, $alamat_perusahaan_provinsi, $alamat_perusahaan_kab_kota, $alamat_perusahaan_kecamatan, $alamat_perusahaan_kelurahan, $status_pekerjaan, $id_pekerjaan_alumni);
