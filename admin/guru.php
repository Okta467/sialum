          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="card card-header-actions mb-4 mt-5">
              <div class="card-header">
                ...
                <button class="btn btn-sm btn-primary toggle_modal_tambah" type="button"><i data-feather="user-plus" class="me-2"></i>Tambah Guru</button>
              </div>
              <div class="card-body">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownFadeIn">
                              ...
                              <button class="dropdown-item toggle_modal_detail_guru" type="button"
                                data-id_guru="<?= $guru['id_guru'] ?>"
                                data-nama_guru="<?= $guru['nama_guru'] ?>"
          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="xnama_guru" type="text" name="xnama_guru" placeholder="Enter nama guru" required>
              </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_tambah').on('click', function() {
          $('#ModalInputGuru .modal-title').html(`<i data-feather="plus-circle" class="me-2 mt-1"></i>Tambah Guru`);
        ...
        $('#datatablesSimple').on('click', '.toggle_swal_hapus', function() {
          ...
          Swal.fire({
            ...
            html: `Hapus data guru: <strong>${nama_guru}?</strong>`,
            icon: "warning",
            ...
            if (result.isConfirmed) {
              Swal.fire({
                ...
                window.location = `guru_hapus.php?xid_guru=${id_guru}&xid_pengguna=${id_pengguna}`;
              });
            }
          });
        });
