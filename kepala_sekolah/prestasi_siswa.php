                ...
                <table id="datatablesSimple">
                  ...
                  <tbody>
                    ...
                    $query_prestasi_siswa = mysqli_query($connection, 
                      "SELECT
                        d.id AS id_prestasi_siswa, d.nama_prestasi, d.file_prestasi, d.created_at AS created_at_prestasi_siswa,
                    ...
                    while ($prestasi_siswa = mysqli_fetch_assoc($query_prestasi_siswa)):
                      ...
                      $tanggal_dibuat = date('Y-m-d', strtotime($prestasi_siswa['created_at_prestasi_siswa']));
                    ?>
    ...
    <script>
      $(document).ready(function() {
        $('#xcetak_laporan').on('click', function() {
          ...
          const url = `laporan_prestasi_siswa.php?dari_tanggal=${dari_tanggal}&sampai_tanggal=${sampai_tanggal}`;
